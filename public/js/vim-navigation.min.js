class VimNavigation{constructor(){this.currentLinkIndex=-1,this.links=[],this.paragraphs=[],this.currentParagraphIndex=-1,this.searchMode=!1,this.searchQuery="",this.searchResults=[],this.searchResultIndex=-1,this.mode="normal",this.init()}init(){this.createModeIndicator(),this.titleCursor=document.querySelector(".site-title .vim-cursor"),this.titleCursor&&this.titleCursor.textContent==="█"&&(this.titleCursor.textContent="|"),this.isInPostContent=document.querySelector(".post-content")!==null,this.updateLinksList(),this.isInPostContent&&this.updateParagraphsList(),this.isHomePage||this.focusOnTitleLink(),document.addEventListener("keydown",this.handleKeyPress.bind(this))}focusOnTitleLink(){const e=document.querySelector(".breadcrumbs a");e&&(this.currentLinkIndex=this.links.indexOf(e),this.highlightCurrentElement())}createModeIndicator(){this.modeIndicator=document.createElement("div"),this.modeIndicator.style.cssText=`
            position: fixed;
            bottom: 20px;
            right: 20px;
            color: var(--primary);
